...
public class Introduction extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        File file = new File(Environment.getExternalStorageDirectory().getAbsolutePath()+"/Musical");
        file.mkdir();
        ...
        Intent mainService = new Intent(this,MyMusicService.class);
        startService(mainService);

        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                startActivity(new Intent(Introduction.this,Musical.class));
                finish();
            }
        }, 5000);
