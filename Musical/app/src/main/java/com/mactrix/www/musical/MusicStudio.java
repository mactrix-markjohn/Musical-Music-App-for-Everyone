...
public class MusicStudio implements MediaPlayer.OnCompletionListener,MediaPlayer.OnPreparedListener
    ...
    public MusicStudio(Context context){
    ...
    public MusicStudio(Context context, int res){
        this.context = context;
